package Business::Invoice::Role::Render;
...
Business::Invoice::Role::Render - The great new Business::Invoice::Role::Render!
...
Perhaps a little code snippet.
    ...
    use Business::Invoice::Role::Render;

    my $foo = Business::Invoice::Role::Render->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Business::Invoice::Role::Render
...
1; # End of Business::Invoice::Role::Render
