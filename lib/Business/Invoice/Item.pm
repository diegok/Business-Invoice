...
Business::Invoice::Item - The great new Business::Invoice::Item!
...
Perhaps a little code snippet.
    ...
    my $foo = Business::Invoice::Item->new();
    ...
...
1; # End of Business::Invoice::Item
