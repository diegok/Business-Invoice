...
Business::Invoice - Invoice your clients from perl
...
This is an invoice representation. 

    use Business::Billing::Invoice;

    my $foo = Business::Billing::Invoice->new();
    ...
